...
#define jd50 jss+1					//D50 of soil particles
#define jagg jd50+1                 // aggrstabilty of soil particles
#define jcoh jagg+1                  // soil cohesion 
#define jrho jcoh+1                 // soil density
#define jerr jrho+1
#define nsoilprop jerr				//number of soil properties considered
...
#define jvts jcm+1					//root tensor strenth (MPa)
#define jrar jvts+1					//gauckler strickler (1/manning) coefficient
#define nlandprop jrar				//number of land use properties
