...
typedef struct {
	...
	DOUBLEMATRIX *ys;
	DOUBLEMATRIX *vs;
	double outero;   /*total mass of soil exported out of the watershed*/
 //	double tero;      //the net erosion totaled over the entire watershed 
	DOUBLEMATRIX *POC;      /*soil particle organic carbon loss[kg] */
	DOUBLEMATRIX *DOC;      /*soil dissolved organic carbon loss[kg] */
	DOUBLEMATRIX *EOC;      /*soil TOTAL organic carbon loss[kg] */
//	double TPOC;            /*soil particle organic carbon loss in whole watershed [t]*/
//	double TDOC;            /*soil dissolved organic carbon loss in whole watershed [t]*/
//	double TEOC;            /* total organic carbon loss in the whole watershed [t]*/
//	double OTPOC;           /*total mass of poc exported into channel*/
 //	double OTDOC;           /* total mass of doc exported into channel */
	double OTEOC;           /* total mass of oc exported into channel */
	DOUBLEMATRIX *pocc;
	DOUBLEMATRIX *docc;
