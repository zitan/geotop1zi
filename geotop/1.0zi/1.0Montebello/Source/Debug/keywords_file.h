...
#define fpocc fasp+1                //concentration of poc
#define fdocc fpocc+1               //concentration of doc
#define fbed fdocc+1			    //bedrock topography (m)
...
#define fer frh+1                   //o. soil erosion maps
#define feoc fer+1                   //o. soil erosion maps
#define fswe feoc+1					//o. snow density maps
